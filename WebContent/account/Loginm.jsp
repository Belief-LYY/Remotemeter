				...
				<div class="login-form"
					...
					<div class="form-group">
						<input type="text" class="form-control login-field" value=""
							placeholder="管理员邮箱" name="email" id="email" /> <label
	...
	function link() {
		...
		if (email.length == 0)
			...
			xmlhttp.open("POST", "/Remotemeter/servlet/LoginServlet?email="
					+ email + "&password=" + password + "&type=2", true);
			xmlhttp.send();
				...
				if (xmlhttp.readyState == 4) {
					if (xmlhttp.status == 200) {
						...
						if (objJson != null && objJson != "") {
							alert("管理员" + objJson + "您好！登陆成功！");
							self.location = '/Remotemeter/intendant/index/index.jsp';
						} else {
