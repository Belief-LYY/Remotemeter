...
<body background="#fafafa;">
	...
	<div
		...
		<ol class="breadcrumb" style="font-size: 15px;">
			...
			<li><a style="color: #4F4F4F;" href="#">用 户></a></li>
		</ol>
		<h2
			style="color: #efefef; font-weight: 700; letter-spacing: 2px; padding-top: 0px; padding-left: 12px;">&nbsp;&nbsp;／用户信息／</h2>


		<div class="col-xs-3"
			style="float: right; margin-right: 120px; letter-spacing: 3px; width: 220px; font-size: 20px; margin-top: -50px;">
			<a
				href="/Remotemeter/servlet/MeterServlet?action=modifyuser&id=<%=request.getSession().getAttribute("id")%>"
		...
		<div>
			<div
				...
				<p>
				<div class="col-xs-3"
					style="float: right; margin-right: -30px; letter-spacing: 3px; width: 220px; font-size: 20px; margin-top: -10px;">
					<a
						href="/Remotemeter/servlet/MeterServlet?action=usermeter&id=<%=request.getSession().getAttribute("id")%>"
						style="font-size: 19px;" class="btn btn-block btn-lg btn-default">他的电表</a>
				</div>
				<!-- 电表循环开始 -->
				<%
						...
						if (type.equals("0")) {
							...
							if (infop != null && infop.size() > 0) {
								for (int j = 0; j < infop.size(); j++) {
									...
									out.println("-姓 &nbsp;&nbsp;&nbsp;名：" + ipersonal.getName() + "<hr>" + "-证件号："
											+ ipersonal.getIdcard() + "<hr>" + "-电 &nbsp;&nbsp;&nbsp;话：" + ipersonal.getPhone()
											+ "<hr>" + "-地 &nbsp;&nbsp;&nbsp;址：" + ipersonal.getAddress() + "<hr>" + "-银行卡："
											+ ipersonal.getBankcard() + "<hr>" + "-邮 &nbsp;&nbsp;&nbsp;箱："
											+ ipersonal.getEmail() + "<hr>" + "-性 &nbsp;&nbsp;&nbsp;别：" + ipersonal.getSex()
											+ "<br>");
								}
							}
						...
						if (type.equals("1")) {
							...
							if (infoc != null && infoc.size() > 0) {
								for (int j = 0; j < infoc.size(); j++) {
									...
									out.println("-姓 &nbsp;&nbsp;&nbsp;名：" + icompany.getName() + "<hr>" + "-证件号："
											+ icompany.getIdcard() + "<hr>" + "-电 &nbsp;&nbsp;&nbsp;话：" + icompany.getPhone()
											+ "<hr>" + "-地 &nbsp;&nbsp;&nbsp;址：" + icompany.getAddress() + "<hr>" + "-银行卡："
											+ icompany.getBankcard() + "<hr>" + "-邮 &nbsp;&nbsp;&nbsp;箱：" + icompany.getEmail()
											+ "<hr>" + "-公 &nbsp;&nbsp;&nbsp;司：" + icompany.getCompany() + "<hr>");
								}
							}
	...
	<footer>
		...
		<div class="container">
			<div class="row">
				<p align="center"
					style="height: 10px; text-align: center; color: #999; letter-spacing: 1px; vertical-align: middle; margin-top: 6px; font-size: 14px; z-index: 99">@
