...
<body background="#fafafa;">
	...
	<div
		...
		<ol class="breadcrumb" style="font-size: 15px;">
			...
			<li><a style="color: #4F4F4F;" href="#">用 户 档 案 管 理 ></a></li>
		</ol>
		<div class="col-xs-3"
					...
					<table class="table table-hover"
						...
						<tbody>
							...
							<tr>
								...
								<td><a style="color: #73BAA9;"
									href="/Remotemeter/intendant/profile/analysis.jsp?meter_id=<%=imeter.getMeter_id()%>">用电分析</a></td>
							</tr>
							<!-- 商品循环结束 -->
							<%
								}
	...
	<div class="col-xs-3"
		...
		<a href="/Remotemeter/intendant/profile/meteradd.jsp"
			style="font-size: 20px;" class="btn btn-block btn-lg btn-default">新增电表</a>
	</div>
		...
		if (!confirm("确认要删除？")) {
			...
			jQuery
					.ajax({
						...
						success : function(data) {
							alert(data);
							window.location.href = '/Remotemeter/intendant/profile/index.jsp';
						}
					});
		}
	}
